...
public class JFrameLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPasswordField.setText("teste");

        jLabel3.setFont(new java.awt.Font("Airstrike Academy", 0, 24)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Registro Processos RSC");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Usuario u = new Usuario(txtLogin.getText(), jPasswordField.getText());
        try {
            Usuario encontrado = fachada.procurarUsuario(u);
            if (encontrado != null) {
                ...
                exibe.fazTelaErro("Erro", "Login ou senha inválidos.");
            }
